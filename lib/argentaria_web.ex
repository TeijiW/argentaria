defmodule ArgentariaWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ArgentariaWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/argentaria_web/templates",
        namespace: ArgentariaWeb
  ...
  defp view_helpers do
    quote do
      ...
      import ArgentariaWeb.ErrorHelpers
      import ArgentariaWeb.Gettext
      alias ArgentariaWeb.Router.Helpers, as: Routes
    end
  end
